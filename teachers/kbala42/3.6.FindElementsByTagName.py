"""
FindElementsByTagName: Etiket adı ile elemana ulaşma
"""
...
# belirlediğimiz etiket adını değişkende saklıyoruz
name= driver.find_element_by_tag_name("input")

#belirlediğimiz elemana klavyeden metin gönderiyoruz
